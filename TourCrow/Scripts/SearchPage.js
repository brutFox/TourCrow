...
function makeSuggPlace(placeId, name, photo, ratting, index) {
    ...
    var retData = "<div class='sugg-element'> <div class='main-area-for-element'><img src='https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=" + photo + "&key=AIzaSyAX1EHCUo6oibCxw3gKDuot3r6B-2wrm2s' alt=''/> <p>" + name + "</p> <p>Ratting : " + ratting + "</p><div class='action-for-sugg'><input type='button' value='Add' onclick=\"addItemToPackage(" + index + ")\"class='add-to-list'/><br/><input type='button' value='Remove' class='remove-from-list'/> </div></div></div>";
    return retData;
}
